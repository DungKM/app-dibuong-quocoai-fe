  ...
  return (
    <>
      <button
        ...
        className={`fixed bottom-24 sm:bottom-6 right-4 z-50 w-14 h-14 rounded-full shadow-2xl flex items-center justify-center transition-all transform hover:scale-110 ${isOpen ? 'bg-slate-800 rotate-90' : 'bg-gradient-to-r from-indigo-500 to-purple-600 animate-pulse'
          }`}
      >
        {isOpen
      ...
      {isOpen && (
        <div className="fixed bottom-44 sm:bottom-24 right-4 z-40 w-[90vw] sm:w-96 bg-white rounded-2xl shadow-2xl border border-slate-200 flex flex-col overflow-hidden h-[55vh] sm:h-[500px] animate-fade-in">
